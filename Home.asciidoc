...
* [[Getting started with AsciiDoc | asciidoc_quickstart]]
* [[Working with figures and cross-references (XREFS) | gsg_figures_and_xrefs.asciidoc]]
* [[Putting code examples on GitHub | gsg_code_samples.asciidoc ]]
* [[Structuring your overall document | gsg_project_structure.asciidoc]]
