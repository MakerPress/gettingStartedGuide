...
////
Need to add something about our expectations that relate to the 50% royalty rate they are getting:

* The text will not get much, if any editing. The authors need to familiarize themselves with http://oreilly.com/oreilly/author/stylesheet.html
* The figures will only get a light touch, so we need SVG for diagrams, and high quality photos.
* we need to put this in the contract going forward.
////
