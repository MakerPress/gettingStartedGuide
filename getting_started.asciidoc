...
So, how do you do this?  Basically, just put all your structural headings (defined by equal signs) in the home file, and then put internal links (which are the page name enclosed in double brackets).  The following sample should give you the basic idea. 
----
= Getting Started Guide
