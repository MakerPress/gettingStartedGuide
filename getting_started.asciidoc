...
So, why bother with this, you ask?  Mostly, we're trying to create a more appealing process that will let you get you writing as quickly as possible, not mucking around with a bunch of tools
