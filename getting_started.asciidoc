...
So, why would bother with this, you ask?  Here are a few reasons:

* AsciiDoc is easy.  If you have ever written a wiki page, then you pretty much know most of what you need to know
* AsciiDoc is plain text with a sensible markup structure.  
