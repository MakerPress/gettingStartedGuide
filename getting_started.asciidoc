...
[NOTE]
====
When you create a new page, one of the most important things to remember is to change the format from "Markdown" to "AscciDoc" in the "Edit Mode" drop down box.


====

image:./select_format.png[]
